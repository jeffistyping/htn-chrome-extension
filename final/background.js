...
function resume()
{
	var remainingAfterPause = null || NaN; 

	do {
		if (alarmDate.getTime - pauseDate.getTime() != null || alarmDate.getTime - pauseDate.getTime() != NaN)
			remainingAfterPause = (alarmDate.getTime() - pauseDate.getTime());
	} while (remainingAfterPause == null || remainingAfterPause == NaN);
